...
const AddAddress = () => {
  ...
  const { axios, user, isUserLoading, navigate } = useContext(AppContext);
  ...
  if (isUserLoading) {
    return (
      <div className="mt-12 flex justify-center text-gray-600">
        Loading...
      </div>
    );
  }
  ...
  return (
    <div className="mt-6 md:mt-12 flex flex-col md:flex-row gap-6 p-4 md:p-6 bg-gray-100 rounded-lg shadow-md">
